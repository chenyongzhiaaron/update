...
public class GlobalSettings {
    ...
    public static Boolean RemoteDebug = Boolean.parseBoolean(prop.getProperty("RemoteDebug", "false"));

    public static String debugServer = prop.getProperty("DebugServer", "");
